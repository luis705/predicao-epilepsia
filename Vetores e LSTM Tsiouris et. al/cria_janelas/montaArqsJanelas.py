...
class Packing:
    def __init__(self, objeto_Tk):
        ...
        objeto_Tk.title(
            "Monta arquivos com janelas de amostras de EEG segundo Tsiouris et al.."
        )
        ...
        self.entryNomeArqSumario = Entry(
            self.frNomeArqSumario, width=80
        )
        self.entryNomeArqSumario.insert(
            END, '/home/rpires/physioNet/chb01-summary.txt'
        )
        ...
        self.txtVarDuracaoPreIctal.set(
            'duração do pré-ictal (minutos):'
        )
        ...
        self.entryDuracaoPreIctal.insert(END, '60')
        self.entryDuracaoPreIctal.pack(side=LEFT)

        self.txtVarDuracaoPosIctal = StringVar()
        self.txtVarDuracaoPosIctal.set(
            'duração do pós-ictal (minutos):'
        )
        ...
        self.entryLocArqEEG.insert(
            END, '/home/rpires/physioNet/compactados'
        )
        ...
        self.lbEscolherPropTreino = Label(
            self.frLtCrisesTreino, text=strAux
        )
        ...
        self.lbEscolherPropTeste = Label(
            self.frLtCrisesTeste, text=strAux
        )
    ...
    def prssBtEscolherCrisesTreino(self):
        ...
        for indice in selecionados:
            numUmaCriseTreino = (
                self.dadosSumario.ltCrisesParaExperimentos[indice]
            )
        ...
        for itInicPeriodo in self.dadosSumario.ltInicPeriodo:
            if (
                itInicPeriodo.antesDeQualCrise
                in self.ltCrisesParaTreino
            ):
        ...
        strAux += strMensagem
        self.txtVarCrisesTreino.set(strAux)
        self.numJanTotalTreino = min(
            self.numJanTotalInterictalTreino,
            self.numJanTotalPreIctalTreino,
        )
        print(
            '\nnúmero de janelas disponíveis para treino:',
            self.numJanTotalTreino,
        )
    ...
    def prssBtEscolherCrisesTeste(self):
        ...
        strAux += strMensagem
        self.txtVarCrisesTeste.set(strAux)
        self.numJanTotalTeste = min(
            self.numJanTotalInterictalTeste,
            self.numJanTotalPreIctalTeste,
        )
        print(
            '\nnúmero de janelas disponíveis para teste:',
            self.numJanTotalTeste,
        )
    ...
    def prssBtEscolhaPropTreinoTesteConcluida(self):
        ...
        self.numJanCadaClasseTreino = int(
            self.numJanTotalTreino * self.propTreino / 100
        )
        print(
            'número de janelas de cada classe para treino:',
            self.numJanCadaClasseTreino,
        )
        strMensagem = (
            '\nnúmero de janelas de cada classe para treino: '
        ...
        self.numJanCadaClasseTeste = int(
            self.numJanTotalTeste * self.propTeste / 100
        )
        print(
            'número de janelas de cada classe para teste:',
            self.numJanCadaClasseTeste,
        )
        strMensagem = (
            '\nnúmero de janelas de cada classe para teste: '
        ...
        self.intervaloInicJanInterictalTreino = (
            self.tTotalInterictalTreino / self.numJanCadaClasseTreino
        )
        print(
        ...
        self.intervaloInicJanPreIctalTreino = (
            self.tTotalPreIctalTreino / self.numJanCadaClasseTreino
        )
        print(
        ...
        self.intervaloInicJanInterictalTeste = (
            self.tTotalInterictalTeste / self.numJanCadaClasseTeste
        )
        print(
        ...
        self.intervaloInicJanPreIctalTeste = (
            self.tTotalPreIctalTeste / self.numJanCadaClasseTeste
        )
        print(
        ...
        numAlgarismosArqTreino = math.ceil(
            math.log10(self.numJanCadaClasseTreino)
        )
        ...
        for it in self.ltInterictaisPTreino:
            ...
            while inicJan < limite:
                (
                    nomeArqEDF,
                    tNoArq,
                ) = self.dadosSumario.ltTAcumArqEdf.emQualArq(inicJan)
                if nomeArqEDF.find('fora') < 0:
                    ...
                    nomeArqJan = (
                        ...
                        + str(numJan).zfill(numAlgarismosArqTreino)
                        + '.txt'
                    )
        ...
        print(
            'lista de tempos de inícios de janelas interictais para treino:'
        )
        ...
        numAlgarismosArqTeste = math.ceil(
            math.log10(self.numJanCadaClasseTeste)
        )
            ...
            while inicJan < limite:
                ...
                if nomeArqEDF.find('fora') < 0:
                    ...
                    nomeArqJan = (
                        self.caminhoPArqsJanelasEEG
                        + '/janTesteInterictal_'
                        + str(numJan).zfill(numAlgarismosArqTeste)
                        + '.txt'
                    )
                    umEEG.gravaArqJanela(
                        nomeArqJan,
