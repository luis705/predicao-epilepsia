...
class Packing:
    def __init__(self, objeto_Tk):
        ...
        self.entryLocArqEEG.insert(END, "/home/rpires/physioNet/compactados")
    ...
    def prssBtEscolherCrisesTreino(self):
        ...
        self.numJanTotalTreino = min(
            self.numJanTotalInterictalTreino, self.numJanTotalPreIctalTreino
        )
        print(
    ...
    def prssBtEscolherCrisesTeste(self):
        ...
        self.numJanTotalTeste = min(
            self.numJanTotalInterictalTeste, self.numJanTotalPreIctalTeste
        )
        print(
    ...
    def prssBtEscolhaPropTreinoTesteConcluida(self):
        ...
        strMensagem = "\nnúmero de janelas de cada classe para treino: " + str(
            self.numJanCadaClasseTreino
        )
        strAux = self.txtVarCrisesTreino.get()
        strAux += strMensagem
        ...
        strMensagem = "\nnúmero de janelas de cada classe para teste: " + str(
            self.numJanCadaClasseTeste
        )
        strAux = self.txtVarCrisesTeste.get()
        strAux += strMensagem
