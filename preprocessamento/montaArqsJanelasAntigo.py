...
class Packing:
    def __init__( self, objeto_Tk ):
        ...
        self.entryLocJanEEG.insert( END, '/home/luis/git/predicao-epilepsia/janelas/antigo/' )
    ...
    def prssBtLocJanEEG( self ):
        self.strLocJanEEG = filedialog.askdirectory(initialdir='/home/luis/git/predicao-epilepsia/janelas/antigo/')
